...
>
	{#if isCheckingAuth}
		...
		<div class="w-full max-w-md space-y-8 p-8 text-center">
			...
			<h2 class="mt-6 text-xl font-bold text-gray-900">Completing authentication...</h2>
			<p class="mt-2 text-sm text-gray-600">Please wait while we verify your sign-in.</p>
		</div>
	{:else if showError}
		...
		<div class="w-full max-w-md space-y-8 p-8">
			<div class="text-center">
				...
				<h2 class="mt-6 text-3xl font-extrabold text-gray-900">Authentication Error</h2>
